...
public class Forgot extends JFrame implements ActionListener
{
    ...
    public Forgot()
    {
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(139,69,19),2),"Forgot-Panel",TitledBorder.LEADING,TitledBorder.TOP,null,new Color(178,34,34)));
        panel.setBounds(45,45,508,281);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()== b2)
        {
            String sq1 = "select * from account where sec_ans=?";
