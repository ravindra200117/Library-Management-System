...
{
    JPanel panel,contentPane,panel_1;
   ...
   public Statistics()
    {
        ...
        panel_1 = new JPanel();
        panel_1.setBorder(new TitledBorder(new LineBorder(new Color(47,79,79),2,true),"Issue-Book-Details",TitledBorder.LEADING,TitledBorder.TOP,null,new Color(0,128,128)));
        ...
        panel = new JPanel();
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0,204,153),2,true),"Return-Book-Details",TitledBorder.RIGHT,TitledBorder.TOP,null,new Color(0,102,51)));
        panel.setBounds(22,299,741,240);
